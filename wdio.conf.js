...
let threads = 1;
if(argv.pcount != undefined && argv.pcount > 1) {
   threads = argv.pcount; 
}


if(argv.parallel == 'true') {
    let tmpSpecDirectory = 'tmp';
...
exports.config = {
    ...
    //
    // The specs are defined as an array of spec files (optionallyc using wildcards
    ...
    reporters: [// Like this with the default options, see the options below
        'cucumberjs-json',
